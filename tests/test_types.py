...
def test_getTypeFromRawString_uint16():
	assert t.getTypeFromRawString("VCU_CM_uint16") == "uint16"

def test_getTypeFromRawString_uint32():
	assert t.getTypeFromRawString("VCU_CM_uint32") == "uint32"

def test_getTypeFromRawString_int8():
	assert t.getTypeFromRawString("VCU_CM_int8") == "int8"

def test_getTypeFromRawString_int16():
	assert t.getTypeFromRawString("VCU_CM_int16") == "int16"

def test_getTypeFromRawString_int32():
	assert t.getTypeFromRawString("VCU_CM_int32") == "int32"

def test_getTypeFromRawString_single():
	assert t.getTypeFromRawString("VCU_CM_single") == "single"
